...
void Parser::syntaxError(int errNumber, string err)
{
	try
	{
		throw err;
...
void Parser::semanticError(string err)
{
	try
	{
		throw err;
...
void Parser::semanticWarning(string err)
{
	try
	{
		throw err;
...
Parser::Parser(vector<Lexeme> sc)
{
...
vector<Lexeme> Parser::getRPNTable()
{
    return RPNTable;
}
